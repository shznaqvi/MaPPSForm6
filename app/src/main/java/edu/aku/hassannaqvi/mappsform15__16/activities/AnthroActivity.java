...
import edu.aku.hassannaqvi.mappsform15__16.JSON.GeneratorClass;
import edu.aku.hassannaqvi.mappsform15__16.R;
import edu.aku.hassannaqvi.mappsform15__16.core.AppMain;
import edu.aku.hassannaqvi.mappsform15__16.databinding.ActivityAnthroBinding;
import edu.aku.hassannaqvi.mappsform15__16.validation.validatorClass;

public class AnthroActivity extends AppCompatActivity {

    ActivityAnthroBinding bi;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        bi = DataBindingUtil.setContentView(this, R.layout.activity_anthro);
        bi.setCallback(this);
