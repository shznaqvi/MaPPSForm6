...
public class SectionBActivity extends AppCompatActivity {
    ...
    public void saveDraft() throws JSONException {
        ...
        sB.put("mp15b02", binding.mp15b02a.isChecked() ? "1" : binding.mp15b02b.isChecked() ? "2" : binding.mp15b02c.isChecked() ? "3" : binding.mp15b02d.isChecked() ? "4" : binding.mp15b02e.isChecked() ? "5" : binding.mp15b02f.isChecked() ? "6" : "0");
        sB.put("mp15b03", binding.mp15b03a.isChecked() ? "1" : binding.mp15b03b.isChecked() ? "2" : "0");
