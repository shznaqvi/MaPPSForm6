...
import edu.aku.hassannaqvi.mapps_form6.contracts.EnrolledContract.EnrolledTable;
import edu.aku.hassannaqvi.mapps_form6.contracts.FormsContract;
import edu.aku.hassannaqvi.mapps_form6.contracts.FormsContract.FormsTable;
...
import edu.aku.hassannaqvi.mapps_form6.contracts.ParticipantsContract.ParticipantsTable;
import edu.aku.hassannaqvi.mapps_form6.contracts.UsersContract;
import edu.aku.hassannaqvi.mapps_form6.contracts.UsersContract.UsersTable;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_ALTER_FORMS = "ALTER TABLE " +
            ...
            FormsTable.COLUMN_SB + " TEXT;";
    private static final String SQL_ALTER_FORMS_C = "ALTER TABLE " +
            FormsTable.TABLE_NAME + " ADD COLUMN " +
            FormsTable.COLUMN_SC + " TEXT;";
