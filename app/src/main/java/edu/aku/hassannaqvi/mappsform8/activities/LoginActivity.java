...
import edu.aku.hassannaqvi.mappsform8.getclasses.GetClusters;
import edu.aku.hassannaqvi.mappsform8.getclasses.GetLHWs;
import edu.aku.hassannaqvi.mappsform8.getclasses.GetUsers;
...
//        Initialize Login Members string
        ...
        try {
            AppMain.installedOn = this
                    .getPackageManager()
                    .getPackageInfo("edu.aku.hassannaqvi.mappsform08", 0)
                    .lastUpdateTime;
